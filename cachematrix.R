...
# However, repetedly calling the solve() function can be inefficient and therefore, 
...
# are meant to get and set values for x and im. The "getter" function are get(to retreive value 
# of x) and getInvrs(to retreive the value im). The "setter" functions are set(to initiate 
...
# then the get constructor function stores the value of x in memory using the makeCacheMatrix. 
